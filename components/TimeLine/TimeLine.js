                ...
                <svg version="1.1" baseProfile="full" width="100%" height="80" xmlns="http://www.w3.org/2000/svg">
                    <g transform={`translate(0, 10)`}>
                        {children && children.map((timeLineEntry, idx) => {
                            ...
                            const nextRender = <>
                                {cloneElement(timeLineEntry, {circleX: circleX, idx: idx})}
                                {idx < children.length -1 && <line x1={lineX1} x2={lineX2 - 28} y1="50" y2="50" strokeWidth="4" strokeOpacity=".15" stroke="black"/>}
                            </>
